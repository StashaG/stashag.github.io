            ...
            <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
              <div className="about-wrapper__info">
                <p className="about-wrapper__info-text">
                  {paragraphOne ||
                    'I fell in love with technology in the 7th grade in my first computer class and from there my curiosity for technology began. I am passionate about coding and I love learning and problem-solving collaboratively in teams.'}
                </p>
                <p className="about-wrapper__info-text">
                  {paragraphTwo ||
